    ...
    <section id={s.aboutUs}>
      ...
      <div className={s.stepsBlock}>
        <div className={s.stepsSection}>
          <h2 className={fonts.headerS}>{commonTranslations.sectionsHeaders.aboutUs.main}</h2>
        ...
        <div className={s.contactUsBtn}>
          <Link className={fonts.labelLSemiBold} to="#anchorContactUs">{commonTranslations.buttons.anchorToForm}</Link>
        </div>
      </div>
    </section>
  )
